...
def prepare_inputs(receptors: Iterable[str], ligands: Iterable,
                   ...
                   **kwargs) -> Dict:
    """Prepare the args dict that will be passed to .docking.dock_inputs()
    ...
    **kwargs
        keyword arguments passed to prepare_from_smis, prepare_from_csv, or
        prepare_from_supply, depending on the nature of ligands

    Returns
    -------
    inputs : Dict
        the keyword arguments to pass to dock_inputs.
    ...
    #     sph_grid = prepare_receptor(
    #         receptor, center, size, docked_ligand,
    #         use_largest, buffer, enclose_spheres
    #     )
    #     if sph_grid is None:
    #         print(f'ERROR: failed to prepare receptor: "{receptor}."',
    #               'Skipping...')
    #     else:
    #         sphs_grids.append(sph_grid)
