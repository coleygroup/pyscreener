...
def run_and_parse_docker(
    argv: List[str],
    parse_file: Callable[[Union[str, PathLike], str], Optional[float]], 
    outfile: Union[str, PathLike], score_mode: str = 'best') -> Optional[float]:
    """Run an instance of the docking program and parse the output for a score
    ...
    parse_file : Callable[[Union[str, PathLike], str], Optional[float]]
        a function to parse the generated output file
    outfile : Union[str, PathLike]
        the filename of an output file generated by the docking program
        that contains the scoring information or a PathLike object pointing to 
        that file
    ...
    try:
        return parse_file(outfile, score_mode)
    except OSError:
        return None
